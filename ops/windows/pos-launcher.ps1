...
function Install-VenuePosPm2Agent {
  ...
  $ecoPath = Write-VenuePosPm2Ecosystem -InstallRoot $InstallRoot -AgentRoot $AgentRoot -Pm2Home $pm2Home

  Write-Host "==> Starting PM2 app $script:VenuePosPm2AppName"
  Invoke-VenuePosPm2 -Pm2Home $pm2Home -Pm2Args @('delete', $script:VenuePosPm2AppName, '--force') | Out-Null
